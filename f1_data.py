# ── F1 Game Center — datos compartidos ──────────────────────────
        ...
        if self.btn_daily.value:
            if self._already_played_today():
                with self.output:
                    ...
                    display(_daily_lock_widget(on_unlock=lambda: (
                        setattr(self.btn_daily, 'value', False),
                        self._start_race()
                    )))
                return
...
F1_EVENTS = [
    ...
    # ── Debuts adicionales ───────────────────────────────────────
    (1980, "Debut de Nelson Piquet en F1 con Brabham",                           "debut"),
    (1983, "Debut de Ayrton Senna en F1 con Toleman",                            "debut"),
    (1985, "Debut de Nigel Mansell como piloto regular con Williams",             "debut"),
    (1991, "Debut de Michael Schumacher en F1 con Jordan en Spa",                "debut"),
    (1993, "Debut de Rubens Barrichello en F1 con Jordan",                       "debut"),
    (2001, "Debut de Kimi Räikkönen en F1 con Sauber",                          "debut"),
    (2007, "Debut de Lewis Hamilton en F1 con McLaren",                          "debut"),
    (2008, "Debut de Sebastian Vettel como piloto titular con Toro Rosso",       "debut"),
    (2010, "Debut de Nico Hülkenberg, Paul di Resta y Sergio Pérez en F1",       "debut"),
    (2015, "Debut de Max Verstappen en F1 con Toro Rosso con 17 años",           "debut"),
    (2019, "Debut de Lando Norris y George Russell en F1",                       "debut"),
    (2021, "Debut de Yuki Tsunoda y Mick Schumacher en F1",                      "debut"),
    (2023, "Debut de Oscar Piastri en F1 con McLaren",                           "debut"),

    # ── Victorias icónicas adicionales ───────────────────────────
    (1950, "Giuseppe Farina gana el primer Gran Premio de F1 en Silverstone",    "victoria"),
    (1954, "Juan Manuel Fangio gana con Mercedes en Reims",                      "victoria"),
    (1961, "Phil Hill se convierte en el primer campeón americano de F1",        "victoria"),
    (1963, "Jim Clark gana 7 de 10 carreras — dominio absoluto con Lotus",       "victoria"),
    (1973, "Jackie Stewart gana su tercer título mundial y se retira",           "victoria"),
    (1978, "Mario Andretti gana el título con Lotus — único campeón americano moderno", "victoria"),
    (1982, "Keke Rosberg gana el título con solo 1 victoria en la temporada",    "victoria"),
    (1986, "Alain Prost gana en Adelaida en la última vuelta del año",           "victoria"),
    (1991, "Ayrton Senna gana en Brasil y llora en el podio",                   "victoria"),
    (1992, "Nigel Mansell gana en Canadá en la vuelta 69 — récord histórico",   "victoria"),
    (1997, "Jacques Villeneuve gana el título en España siendo el último canadiense campeón", "victoria"),
    (2003, "Kimi Räikkönen pierde el título ante Schumacher por 2 puntos",      "victoria"),
    (2006, "Alonso gana su segundo título en Brasil ante Schumacher",            "victoria"),
    (2007, "Räikkönen gana el título en la última carrera por 1 punto",          "victoria"),
    (2009, "Jenson Button gana con Brawn GP, el equipo surgido de las cenizas de Honda", "victoria"),
    (2011, "Vettel logra 15 victorias en una temporada — récord hasta 2023",    "victoria"),
    (2012, "Vettel remonta de último a primero en Brasil para ganar el título",  "victoria"),
    (2014, "Daniel Ricciardo gana su primera carrera de F1 en Canadá",          "victoria"),
    (2016, "Max Verstappen gana en España con 18 años — debutó esa misma semana con Red Bull", "victoria"),
    (2017, "Hamilton gana el título en México con 3 carreras de antelación",     "victoria"),
    (2018, "Hamilton supera los 200 puntos de ventaja en la segunda mitad de temporada", "victoria"),
    (2020, "Lance Stroll clasifica en pole en Turquía bajo la lluvia",           "victoria"),
    (2021, "Verstappen y Hamilton chocan en Monza — ambos abandonan",            "victoria"),
    (2022, "Carlos Sainz gana su primera carrera en Gran Bretaña con Ferrari",   "victoria"),
    (2022, "George Russell gana en Brasil — primera victoria con Mercedes",      "victoria"),
    (2023, "Alonso regresa al podio con Aston Martin en las primeras carreras",  "victoria"),
    (2024, "Lando Norris gana en Miami — primera victoria en F1",                "victoria"),
    (2024, "Oscar Piastri gana en Hungría — primera victoria en F1",             "victoria"),

    # ── Cambios de reglamento adicionales ────────────────────────
    (1950, "Se establece la Fórmula 1 como campeonato oficial de la FIA",        "reglamento"),
    (1968, "Se permiten los patrocinios comerciales en los coches de F1",        "reglamento"),
    (1977, "Lotus introduce el efecto suelo — revolución aerodinámica",          "reglamento"),
    (1983, "Se prohíbe el efecto suelo — autos de fondo plano obligatorio",      "reglamento"),
    (1994, "Se introduce el reabastecimiento de combustible durante carrera",    "reglamento"),
    (2003, "Nuevo formato de clasificación de una vuelta — una sola chance",     "reglamento"),
    (2005, "Se prohíbe cambiar neumáticos en seco durante la carrera",           "reglamento"),
    (2008, "Se introduce el sistema de puntos para los 8 primeros clasificados", "reglamento"),
    (2013, "Se prohíbe el DRS en las últimas vueltas del GP — luego revertido",  "reglamento"),
    (2016, "Se introduce la clasificación por eliminación — rápidamente revertida", "reglamento"),
    (2018, "Se introduce el Halo — dispositivo de protección de la cabeza",      "reglamento"),
    (2019, "Se simplifica el alerón delantero para mejorar los adelantamientos", "reglamento"),
    (2021, "Se introduce el formato Sprint en varios Grandes Premios",           "reglamento"),
    (2023, "Se amplía el calendario a 23 Grandes Premios — récord histórico",    "reglamento"),

    # ── Récords adicionales ───────────────────────────────────────
    (1988, "McLaren gana 15 de 16 carreras — récord de dominio por equipo",      "record"),
    (1992, "Nigel Mansell consigue 14 poles en una temporada — récord histórico","record"),
    (2004, "Schumacher gana 13 de 18 carreras en la temporada más dominante",    "record"),
    (2013, "Sebastian Vettel gana 9 carreras consecutivas al final de temporada","record"),
    (2016, "Nico Rosberg gana el título con solo 9 victorias — el mínimo desde 2010", "record"),
    (2022, "Max Verstappen gana 15 carreras — nuevo récord de victorias en temporada", "record"),
    (2023, "Verstappen logra 10 victorias consecutivas — récord absoluto",       "record"),

    # ── Tragedias y accidentes ────────────────────────────────────
    (1955, "Desastre de Le Mans — más de 80 muertos, varias naciones se retiran de carreras", "tragedia"),
    (1958, "Mike Hawthorn gana el título pero muere en accidente de tráfico meses después",   "tragedia"),
    (1968, "Jim Clark muere en una carrera de Fórmula 2 en Hockenheim",                       "tragedia"),
    (1970, "Jochen Rindt gana el título de forma póstuma tras morir en Monza",                "tragedia"),
    (1973, "Roger Williamson muere en Zandvoort, David Purley intenta salvarlo",              "tragedia"),
    (1975, "Mark Donohue muere tras un accidente en el GP de Austria",                        "tragedia"),
    (1994, "Roland Ratzenberger muere en clasificación en Imola — día antes que Senna",       "tragedia"),
    (1994, "Ayrton Senna muere en el GP de San Marino en Tamburello",                         "tragedia"),
    (2015, "Jules Bianchi fallece nueve meses después de su accidente en Japón 2014",         "tragedia"),
]
...
# ── Historial de equipos por piloto (para Cadena) ───────────
_DRIVER_YEARS = {
...
CHAIN_POOL = sorted(
    ...
    if d in RAW_F1 and (RAW_F1[d][2] > 0 or RAW_F1[d][3] >= 3)
)
...
DATA_PATH = Path.home() / ".f1_streamlit_data.json"
...
def daily_played(key):
    today = datetime.date.today().isoformat()
    return load_data().get("daily_once", {}).get(key) == today

def mark_daily_played(key):
    d = load_data()
    d.setdefault("daily_once", {})[key] = datetime.date.today().isoformat()
    save_data(d)
